...
def startDecryption():
    ...
    btn_open_file = Button(decryption_window, text="Choose File..", font='arial 13', bg="#E8DDB5", padx=10, relief=FLAT,
                           command=viewData)
...
def startEncryption():
    ...
    btn_create = Button(encryption_window, text="Create", font='arial 13', bg="#E8DDB5", padx=10, relief=FLAT,
                        command=saveData)
...
btn_start_encryption = Button(root, text="Start Encryption", font='arial 13', bg="white", command=startEncryption,
                              relief=FLAT, padx=10)
btn_start_encryption.place(relx=0.3, rely=0.6, anchor=CENTER)

btn_start_decryption = Button(root, text="Start Decryption", font='arial 13', bg="white", command=startDecryption,
                              relief=FLAT, padx=10)
